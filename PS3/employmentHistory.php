...
<body>
	...
	<table>
		...
		<tr>
			<td><textarea name=desc rows=10 cols=50 required><?php echo $_SESSION['desc']?></textarea></td>
		</tr>
	</table>
...
function employmentField(){
	$('h1').append("<table><tr><td>Enter the Start Date:</td><td><input name=startDate type=text value='<?php echo $_SESSION['startDate']?>' required /></td></tr><tr><td>Enter the End Date:</td><td><input name=endDate type=text value='<?php echo $_SESSION['endDate']?>' required /></td></tr></table><table><tr><th>Enter a brief description of your responsibilities:</th></tr><tr><td><textarea name=desc rows=10 cols=50 required><?php echo $_SESSION['desc']?></textarea></td></tr></table>");
}
